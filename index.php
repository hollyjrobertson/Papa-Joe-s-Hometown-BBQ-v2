...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
  <img class="w3-image" src="assets/images/banner.png" alt="Hamburger Catering" width="100%">
...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64" id="about">
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="assets/images/us.jpg" class="w3-round w3-image" alt="Table Setting" style="width:100%">
    </div>
  ...
  <div class="w3-container w3-padding-64" id="contact">
    ...
    <form action="index.php#contact" method="post">
      ...
      <p><label>For security, please answer the following question</label></p>
      <p><img src="assets/images/captcha.png" alt="8 minus 1"></p>
      <p><input class="w3-input w3-padding-16" type="text" placeholder="Answer" required name="Answer" style="width:20%"></p>
